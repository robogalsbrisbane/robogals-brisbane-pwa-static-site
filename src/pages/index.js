...
export default function HomePage() {
  return (
    <div>
        <section class="hero is-small primary-bg">
            <div class="hero-body Hero-text">
                <h2 id="Page-quote"><b>Inspire</b>, <b>engage</b> and <b>empower</b> young women into
                    engineering related fields</h2>
            </div>
        </section>
